...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form, tag: 'div', class: 'form-group', error_class: 'is-invalid' do |b|
    ...
    b.use :error, wrap_with: { tag: 'small', class: 'text-danger' }
  ...
  config.wrappers :horizontal_form, tag: 'div', class: 'form-group row', error_class: 'is-invalid' do |b|
    ...
    b.wrapper :input_wrapper, tag: 'div' do |ba|
      ...
      ba.use :error, wrap_with: { tag: 'small', class: 'text-danger' }
...
#      end
      wr.use :input
      wr.use :error, wrap_with: { tag: 'small', class: 'text-danger' }
  ...
  config.wrappers :multi_select, tag: 'div', class: 'form-group row', error_class: 'is-invalid' do |b|
    ...
    b.wrapper :input_wrapper, tag: 'div', class: 'form-inline' do |ba|
      ba.use :input, class: 'form-control'
      ba.use :error, wrap_with: { tag: 'small', class: 'text-danger' }
      ba.use :hint,  wrap_with: { tag: 'small', class: 'text-muted' }
    end
